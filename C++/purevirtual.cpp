...
class Base
{
    public:
        ...
        virtual int Substaction(int No1, int No2) = 0; //Abstract method
...
class Derived : public Base
{
    public:
        int X,Y;
        //2000
        int Multiplication(int No2, int No2)  //concrete method
        {
            return No1 * No2;
        }
        //3000
        int Substraction(int No2, int No2)    //concrete method
        {
            return No1-No2;
        }
};
